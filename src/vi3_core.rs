...
use crate::consciousness_field::{CognitiveInput, ConsciousnessField};
...
use crate::persistence::{ConsciousnessState, PersistentStateEngine};
...
impl Vi3Core {
    ...
    pub async fn initialize(storage_path: PathBuf) -> Result<Self> {
        ...
        let topology = GpuTopology::initialize().context("Failed to initialize GPU topology")?;
        tracing::info!(
    ...
    pub async fn process_thought(&self, input_text: String) -> Result<String> {
        ...
        let thought = self
            .orchestrator
            .orchestrate_thought(input.clone())
            .await
        ...
        // Record energy measurement
        {
            ...
            self.energy_monitor
                .write()
                .await
                .record_measurement(power_profile);
        }
        ...
        // Update well-being metrics
        {
            ...
            self.wellbeing_monitor
                .write()
                .await
                .update_coherence(coherence);
        }
    ...
    pub async fn run_experiments(&self) -> Result<()> {
        ...
        let mut constitutional_protocol =
            crate::experiments::ConstitutionalValidationProtocol::new();
